...
El curso está no aprobado cuando no se cumple con el 75% de asistencias o cuando no se han obtenido los resultados formativos esperados, lo cual se expresa en una calificación de R o D. En estos casos se debe cursar nuevamente la actividad formativa. 